/* $Header:   D:/SWLab/VMdb/2000Series/App/MENU1A.C_V   1.18.2.0   02 Sep 2008 21:05:30   nhahmed  $ */
/****************************************************************************/ 
/*                                                                          */
/*                                                                          */
...
/*
 ...
 --------------------------------- REVISIONS --------------------------------
   ...
   ==========     ========       ======      ===========
      ...
      1.11        02.06.98       BJB         Changed type of PeakPwrActual to
                                              PERCENTX10.
      1.12        08-07-98       BEKymer     Changed all peak power values to
                                              PERCENTX10.
      1.12.6.1    02-07-99       JZ          removed DVS added Mask1, Cond1, Mask2, Cond2
...
/* This file deals with Alarm submenus for the + and - Peak Power Limit     */
