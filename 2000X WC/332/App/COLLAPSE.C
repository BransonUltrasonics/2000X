/* $Header:   D:/SWLab/VMdb/2000Series/App/COLLAPSE.C_V   1.32   10 Sep 2009 15:59:30   bkymer  $ */
/****************************************************************************/ 
/*                                                                          */
/*                                                                          */
...
/*--------------------------- MODULE DESCRIPTION ---------------------------*/
/*                                                                          */
/* Module name: Collapse Mode                                               */
/*                                                                          */
/* Filename:    Collapse.c                                                  */
/*                                                                          */
/* Function Name: SelectCollapseWeldSequence                                */
/*                                                                          */
...
/*     4       08-13-96   BEKymer    Add state SonicsOn3B                   */
...
/*    1.13     09.09.97   JBerman    Added WeldSequence index test                                                                 */
...
/*    1.23     06-29-00   DJL        Changed MODEL to LEVEL                 */
/*    1.24     07-11-00   BEKymer/DJL added actuator=aef to if statement.   */
/*    1.26     05-28-02   BEKymer    Add ClearMemST                         */
/*    1.27     09-11-03   BEKymer    Add energy braking state, remove Mem   */
/*                                    ClearST                               */
/*    1.28     04-06-04   VSharma    Added SVInterlock & ExtTrgDelay state. */
/*    1.29     04-27-04   VSharma    If SVInterlock input & output are not  */
/*                                   configured, don't include 'WaitSVST'.  */
/*    1.30     08-04-04   JOY        States StartData & StopData added in   */
/*                                    LEVEL_t also, Ver9.0 MH1 issue #3858  */
/*    1.31     09-02-08   NHAhmed    CleanUp for multi-language support.    */
/*    1.32     09-10-09   BEkymer    Add new define MICRO where needed      */
/*                                                                          */
/*                                                                          */
/*                                                                          */
/*----------------------------- DESCRIPTION --------------------------------*/
...
void SelectCollapseWeldSequence(void)
/***************************************************************************/
/*                                                                         */
/* This Collapse Mode Weld sequence will be based on LEVEL number and      */
...
/*------  Here we turn on some sonics  ------*/
   ...
   WeldSequence[i++] = &SonicsOn3B;


/*------  Determine if stepping  is needed  ------*/

   WeldSequence[i++] = &SonicsOn6;        
