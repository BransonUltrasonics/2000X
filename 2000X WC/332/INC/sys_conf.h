/* $Header:   K:/APPS/PVCS Pro/332new/INC/sys_conf.h_v   1.3   May 03 1999 10:51:48   lmarkure  $ */
/* @(#) pSOSystem/68K V2.2.2: apps.v22/xxxx/sys_conf.h (proberom 68k) 3.21 98/01/12 10:03:13 */
/***********************************************************************/
/*                                                                     */
/*   MODULE:  sys_conf.h                                               */
/*   DATE:    98/01/12                                                 */
...
/*------------------------------- REVISIONS ---------------------------------
 ...
 ===== ======== ====== ======================================================
 1.0   04/06/99 LAM    updated from sys_conf.h ver 2.7
 1.1   04/29/99 LAM    updated per old sys_conf.h
 1.2   05/02/99 LAM    updated to run with diab
...
#define SC_SD_DEBUG_MODE    DBG_AP
...
/* happen.                                                             */
/*---------------------------------------------------------------------*/
#define SC_AUTOINIT         IO_NOAUTOINIT
...
#define SD_NISM_DIRADDR       SD_VME_BASE_ADDR + 0x00000400
#define SC_NISM_BUFFS         10
#define SC_NISM_LEVEL         1
...
/*---------------------------------------------------------------------*/
#define SD_KISM               0
#define SD_KISM_DIRADDR       SD_VME_BASE_ADDR + 0x00000580
...
#define SC_DEV_TIMER         NO         /* Periodic tick timer         */
...
#define SC_DEVMAX            8         /* Maximum device number       */
...
#define KC_NTASK       20        /* max number of tasks                 */
#define KC_NQUEUE      20       /* max number of message queues        */
#define KC_NSEMA4      5        /* max number of semaphores            */
#define KC_NMSGBUF     400      /* max number of message buffers       */
#define KC_NTIMER      2        /* max number of timers                */
#define KC_NLOCOBJ     60       /* max number of local objects         */
#define KC_TICKS2SEC   200      /* clock tick interrupt frequency      */
#define KC_TICKS2SLICE 10       /* time slice quantum, in ticks        */
#define KC_INTSTK      0x1000   /* interrupt stack size                */
#define KC_SYSSTK      0x3000   /* pSOS+ system stack size (bytes)     */
#define KC_ROOTSSTK    0x200   /* ROOT supervisor stack size          */
#define KC_ROOTUSTK    0        /* ROOT user stack size                */
#define KC_ROOTMODE    0x2700 /* ROOT initial mode           */
#define KC_ROOTPRI     255      /* ROOT task priority                  */
...
#define NC_BUFS_256    0        /* number of 128 byte buffers          */
#define NC_BUFS_512    0        /* number of 512 byte buffers          */
#define NC_BUFS_1024   0        /* number of 1k byte buffers           */
#define NC_BUFS_2048  48         /* number of 2k byte buffers           */
#define NC_BUFS_4096   0        /* number of 4k byte buffers           */

#define NC_MAX_BUFS    4        /* max number of NC_BUFS types         */
...
/*---------------------------------------------------------------------*/
#define PM_CMODE         2      /* 1 = networking, 2 = serial          */
#define PM_DEV           DEV_SERIAL|1      /* Minor Device number  for            */
                                /* serial channel if used              */
#define PM_BAUD          19200   /* Baud rate for serial chnl           */
...
#define GS_BUFS_64     8        /* number of 64 byte buffers           */
#define GS_BUFS_128    8        /* number of 128 byte buffers          */
#define GS_BUFS_256    8        /* number of 256 byte buffers          */
#define GS_BUFS_512    8        /* number of 512 byte buffers          */
#define GS_BUFS_1024   8        /* number of 1k byte buffers           */
#define GS_BUFS_2048   8        /* number of 2k byte buffers           */
