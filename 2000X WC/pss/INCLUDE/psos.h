/* $Header:   K:\APPS\PVCS Pro\PSS68K.222\INCLUDE\psos.h_v   1.1   Apr 06 1999 13:21:56   lmarkure  $ */
/* @(#) pSOSystem/68K V2.2.2: include/psos.h (68k) 1.43 97/11/03 09:08:04 */
/***********************************************************************/
/*                                                                     */
/*   MODULE:  psos.h                                                   */
/*   DATE:    97/11/03                                                 */
/*   PURPOSE: Structure typedefs, function prototypes, macros, and     */
/*            symbol definitions for pSOS+ kernel                      */
/*                                                                     */
/*---------------------------------------------------------------------*/
/*                                                                     */
/*          Copyright 1988 - 1994, Integrated Systems, Inc.            */
/*                         ALL RIGHTS RESERVED                         */
/*                                                                     */
...
/* --------------------------------- REVISIONS -------------------------
 ...
 1.1   04/06/99 LAM     chged prototype of q_receive and q_send to match
                        our application.
...
/***********************************************************************/
/* pSOS+ System Calls (defined in psos.s)                              */
/***********************************************************************/
...
UINT32 q_receive(UINT32 Qid, UINT32 Flags, UINT32 Timeout, void *Message);
/*ULONG q_receive(ULONG qid, ULONG flags, ULONG timeout, ULONG msg_buf[4]); */
UINT32 q_send(UINT32 Qid, void *Message);
...
#define T_USER          0x00000000   /* User mode */
#define T_LEVELMASK0    0x00000000   /* Interrupt mask level 0 bits */
#define T_LEVELMASK1    0x00000100   /* Interrupt mask level 1 bits */
#define T_LEVELMASK2    0x00000200   /* Interrupt mask level 2 bits */
#define T_LEVELMASK3    0x00000300   /* Interrupt mask level 3 bits */
#define T_LEVELMASK4    0x00000400   /* Interrupt mask level 4 bits */
#define T_LEVELMASK5    0x00000500   /* Interrupt mask level 5 bits */
#define T_LEVELMASK6    0x00000600   /* Interrupt mask level 6 bits */
#define T_LEVELMASK7    0x00000700   /* Interrupt mask level 7 bits */
#define T_NOISR         0x00000700   /* Interrupts disabled */
...
#define Q_WAIT_FOREVER        0         /* q_receive - timeout                */
#define Q_NODE_0              0         /* node number                        */
#define PSOS_NOERROR 0        /* PSOS CALL WAS ERROR FREE */
#define PSOS_OK      0        /* also means pSOS call was error-free */
#define RN_WAIT_FOREVER       0         /* used with timeout, wait forever    */
#define T_NODE_0                0       /* node number                        */
#define PT_NODE_0             0         /* node number for use with pt_ident  */
